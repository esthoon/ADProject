...
<p>
    ...
    <p>
        ...
        <br />
        <asp:GridView ID="GridViewPOStagingSummary" runat="server" AutoGenerateColumns="False" OnDataBound="GridViewPOStagingSummary_DataBound">
            <Columns>
                ...
                <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:Button ID="Button3" runat="server" CausesValidation="false" CommandName="" Text="Remove" OnClick="Button3_Click" UseSubmitBehavior="false" />
                        </ItemTemplate>
                    </asp:TemplateField>
            </Columns>
        </asp:GridView>
